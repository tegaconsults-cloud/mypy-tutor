 ...
 *  The frontend lives on Vercel (e.g. mypytutor.vercel.app).
 *  The FastAPI backend lives on Render (https://mypytutor.onrender.com).
 *  All backend calls are made directly to the Render URL, so this SW only
 *  caches static Vercel-hosted assets. API calls are treated as passthrough.
 */

const CACHE_VERSION = 'mypy-tutor-v9';
const OFFLINE_URL   = '/';

// Backend origin — all requests to this origin pass through to network
const BACKEND_ORIGIN = 'https://mypytutor.onrender.com';
...
const PASSTHROUGH_ORIGINS = new Set([
  'mypytutor.onrender.com',     // FastAPI backend — never cache API calls
  'accounts.google.com',
