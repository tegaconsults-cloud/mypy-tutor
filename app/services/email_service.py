...
Env vars:
  ...
  SUPPORT_EMAIL     support@mypytutor.com.ng  (reply_to on all outbound emails)
  ADMIN_EMAIL       real inbox — set to tega.com.ng@gmail.com in Render env vars
  APP_URL           https://mypytutor.onrender.com
  FRONTEND_URL      https://mypytutor.com.ng
  EMAIL_USER / EMAIL_PASS  — Gmail SMTP fallback credentials
"""
...
def _support_email() -> str:
    return _e("SUPPORT_EMAIL", "support@mypytutor.com.ng")
...
def _shell(body_html: str, preview: str = "") -> str:
    ...
    return (
        ...
        + supp + "</a>"
        " &middot; "
        "<a href='https://whatsapp.com/channel/0029Vb6IDBz8V0tmPLtYwq2v' "
        "style='color:#25D366;font-size:0.72rem;text-decoration:none;font-weight:600;'>"
        "&#128242; WhatsApp Channel</a>"
...
def send_enquiry_email(name: str, email: str, category: str,
                       ...
                       learner_id: str = "") -> None:
    """
    Forward a user support enquiry to support@mypytutor.com.ng, which
    forwards to tega.com.ng@gmail.com via Resend Inbound or DNS email forwarding.
    reply_to is set to the user's email so the admin can reply directly.
    Also sends a confirmation receipt to the user.
    """
    support    = _support_email()   # support@mypytutor.com.ng
    admin_dest = _e("ADMIN_EMAIL", support)   # override with ADMIN_EMAIL env var if set
    app   = _frontend_url()
